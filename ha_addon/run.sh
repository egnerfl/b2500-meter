...
if bashio::config.has_value 'custom_config' && [ -f "/config/$(bashio::config 'custom_config')" ]; then
    ...
    # Generate default config
    {
        ...
        echo "SHELLY_PUSH_MODE=$(bashio::config 'shelly_push_mode')"
        echo "SHELLY_PUSH_TARGET_IP=$(bashio::config 'shelly_push_target_ip')"
        echo "SHELLY_PUSH_TARGET_PORT=$(bashio::config 'shelly_push_target_port')"
        echo "SHELLY_PUSH_INTERVAL=$(bashio::config 'shelly_push_interval')"
